                ...
                <div class="input-group mb-3">
                    ...
                    <div class="input-group mb-3">
                        ...
                        <select class="custom-select" required name="type" >
                            ...
                            <option value="2" >dft جديد</option>
                            <option value="3" >dft قديم</option>
                            <option value="4" >chimra</option>
            ...
            <div class="modal-body"> 
                <form method="POST" action="{{ route('service.update', ['service' => $service->id]) }}" enctype="multipart/form-data">
                    ...
                    <div class="input-group mb-3">
                        ...
                        <input type="text" class="form-control" value="{{$service->basic_price}}" required placeholder="السعر"  name="basic_price" aria-label="basic_price" aria-describedby="basic-addon2">
                    </div>
                    <div class="input-group mb-3">
                        <div class="input-group-prepend">
