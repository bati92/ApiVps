                                ...
                                <table class="table table-hover js-basic-example dataTable table-custom mb-0">
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            ...
                                            <td><img src="{{asset('assets/images/kontorSections/'.$service->image)}}" data-toggle="tooltip" data-placement="top" title="Team Lead" alt="Avatar" class="width35 rounded"></td>
                                            @if(auth()->user()->role==1)
                                            <td class="project-actions">
                                                <a href="#defaultModal" data-toggle="modal" data-target="#defaultModal">
                                                <a href="/kontor/{{$service->id}}/category " class="btn btn-sm btn-outline-primary"><i class="icon-eye"></i></a>
